...
> Product phases in this document (marketplace conversion) are **distinct** from the SaaS infrastructure phases in [`IMPLEMENTATION-PHASES.md`](../plans/IMPLEMENTATION-PHASES.md) and [`saas-next-steps.md`](../../saas-next-steps.md).
